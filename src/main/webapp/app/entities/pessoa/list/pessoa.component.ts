...
export class PessoaComponent implements OnInit {
  ...
  trackId(_index: number, item: IPessoa): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IPessoa[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
